...
caption_filename = r'F:/AP/AuthorProfiling/Arabic/captions_output_Arabic.txt'
output_filename = r'F:/AP/AuthorProfiling/Arabic/arabic_captions_output_lsa_components.txt'
