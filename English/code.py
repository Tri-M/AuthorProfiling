...
folder_path = 'D:/sem_8/Information Retrieval/pan18-author-profiling-training-dataset-2018-02-27/pan18-author-profiling-training-dataset-2018-02-27/es/text'
...
def load_lsa_components(filename):
    ...
    for user_label, lsa_values in lsa_components_dict.items():
        ...
        lsa_components_dict[user_label] = lsa_values + [0] * padding_length  
